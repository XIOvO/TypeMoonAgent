...
当前项目的产品目标、架构、实现事实与开发顺序统一以 [项目设计与开发总纲 V1](project-design-development-v1.md) 为入口。下列文件是各领域的专题规范；其中较早的“当前状态”或“下一步”描述若与总纲冲突，以总纲和代码测试为准。

| 文档 | 用途 |
| --- | --- |
| [project-design-development-v1.md](project-design-development-v1.md) | 当前权威总纲：目的、方案、架构、实现状态和路线图 |
...
| [reference/CIF-v0.2-adaptation.md](reference/CIF-v0.2-adaptation.md) | CIF 上游规范快照、版本指纹与本项目适配边界 |
...
| [portrait-expression-system.md](portrait-expression-system.md) | 立绘图集、表情定位、情绪映射和回退规则 |
...
| [plugin-protocol-v1.md](plugin-protocol-v1.md) | 插件能力、组合与权威写入边界 |
| [map-and-navigation.md](map-and-navigation.md) | 正式地图与导航能力的模型、边界和分阶段实现 |
