...
test("Pi prompt keeps current facts separate from subjective CIF context", () => {
  const prompt = JSON.parse(buildCifPiPrompt(
    ...
    { characterId: "mash", identity: [{ id: "i", sessionId: "s", characterId: "mash", section: "values", content: "Protect others.", sourceIds: [], version: 1 }], runtimeState: { sessionId: "s", characterId: "mash", attention: [], emotions: [], activeGoals: [], updatedAt: "2026-01-01" }, evidence: [], epistemicStates: [{ id: "e", sessionId: "s", characterId: "mash", proposition: "The player is safe.", status: "uncertain", confidence: 0.3, supportingEvidenceIds: [], opposingEvidenceIds: [], version: 1 }], interpretiveModels: [] },
  ));
